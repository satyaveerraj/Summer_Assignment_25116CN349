...
// Structure to hold student marksheet details
struct Student {
    int rollNumber;
    string name;
    vector<int> marks;   // marks for subjects
    int total;
    double percentage;
    char grade;
};
...
// Function to add student marksheet
...
// Function to search marksheet by roll number
